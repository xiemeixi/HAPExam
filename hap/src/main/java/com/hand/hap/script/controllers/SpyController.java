...
package com.hand.hap.script.controllers;
...
public class SpyController {
    ...
    @RequestMapping(value = "/restful/spy/sql", method = RequestMethod.POST,
            consumes = "text/plain",
    ...
    @RequestMapping(value = "/restful/spy/js", method = RequestMethod.POST,
