...
public class SysPreferences extends BaseDTO {
    ...
    public Long getPreferencesLevel() {
        return preferencesLevel;
    }

    public void setPreferencesLevel(Long preferencesLevel) {
        this.preferencesLevel = preferencesLevel;
    }
