...
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID('[dbo].[sys_role_resource_item]') AND type IN ('U'))
...
ON [PRIMARY]
GO
EXEC sp_addextendedproperty 'MS_Description', N'表ID，主键，供其他表做外键', 'SCHEMA', 'dbo', 'TABLE', 'sys_role_resource_item', 'COLUMN', 'RSI_ID'
GO
EXEC sp_addextendedproperty 'MS_Description', N'角色ID', 'SCHEMA', 'dbo', 'TABLE', 'sys_role_resource_item', 'COLUMN', 'ROLE_ID'
GO
EXEC sp_addextendedproperty 'MS_Description', N'功能控件ID', 'SCHEMA', 'dbo', 'TABLE', 'sys_role_resource_item', 'COLUMN', 'RESOURCE_ITEM_ID'
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_role_resource_item] ADD
...
-- ----------------------------
ALTER TABLE [dbo].[sys_role_resource_item] SET (LOCK_ESCALATION = TABLE)
GO
