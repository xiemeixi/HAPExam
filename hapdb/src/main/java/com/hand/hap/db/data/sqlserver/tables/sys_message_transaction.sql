...
EXEC sp_addextendedproperty 'MS_Description', N'Record的版本号，每发生update则自增', 'SCHEMA', 'dbo', 'TABLE',
                            'sys_message_transaction', 'COLUMN', 'OBJECT_VERSION_NUMBER'
GO
EXEC sp_addextendedproperty 'MS_Description', N'对Record最后一次操作的系统内部请求id', 'SCHEMA', 'dbo', 'TABLE',
                            'sys_message_transaction', 'COLUMN', 'REQUEST_ID'
GO
EXEC sp_addextendedproperty 'MS_Description', N'对Record最后一次操作的系统内部程序id', 'SCHEMA', 'dbo', 'TABLE',
                            'sys_message_transaction', 'COLUMN', 'PROGRAM_ID'
GO
EXEC sp_addextendedproperty 'MS_Description', N'被用户创建', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'CREATED_BY'
GO
EXEC sp_addextendedproperty 'MS_Description', N'创建日期', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'CREATION_DATE'
GO
EXEC sp_addextendedproperty 'MS_Description', N'最后被用户修改', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'LAST_UPDATED_BY'
GO
EXEC sp_addextendedproperty 'MS_Description', N'最后修改日期', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'LAST_UPDATE_DATE'
GO
EXEC sp_addextendedproperty 'MS_Description', N'属性1', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'ATTRIBUTE1'
GO
EXEC sp_addextendedproperty 'MS_Description', N'属性2', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'ATTRIBUTE2'
GO
EXEC sp_addextendedproperty 'MS_Description', N'属性3', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'ATTRIBUTE3'
GO
EXEC sp_addextendedproperty 'MS_Description', N'属性4', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'ATTRIBUTE4'
GO
EXEC sp_addextendedproperty 'MS_Description', N'属性5', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'ATTRIBUTE5'
GO
EXEC sp_addextendedproperty 'MS_Description', N'属性6', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'ATTRIBUTE6'
GO
EXEC sp_addextendedproperty 'MS_Description', N'属性7', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'ATTRIBUTE7'
GO
EXEC sp_addextendedproperty 'MS_Description', N'属性8', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'ATTRIBUTE8'
GO
EXEC sp_addextendedproperty 'MS_Description', N'属性9', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'ATTRIBUTE9'
GO
EXEC sp_addextendedproperty 'MS_Description', N'属性10', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'ATTRIBUTE10'
GO
EXEC sp_addextendedproperty 'MS_Description', N'属性11', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'ATTRIBUTE11'
GO
EXEC sp_addextendedproperty 'MS_Description', N'属性12', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'ATTRIBUTE12'
GO
EXEC sp_addextendedproperty 'MS_Description', N'属性13', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'ATTRIBUTE13'
GO
EXEC sp_addextendedproperty 'MS_Description', N'属性14', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'ATTRIBUTE14'
GO
EXEC sp_addextendedproperty 'MS_Description', N'属性15', 'SCHEMA', 'dbo', 'TABLE', 'sys_message_transaction', 'COLUMN',
                            'ATTRIBUTE15'
GO
